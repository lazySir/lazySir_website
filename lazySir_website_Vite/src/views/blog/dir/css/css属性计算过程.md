...
![css计算图](https://cdn.jsdelivr.net/gh/lazySir/image-host@main/lazySir_website/blog/css/css计算1.png)
...
![css计算图](https://cdn.jsdelivr.net/gh/lazySir/image-host@main/lazySir_website/blog/css/css计算2.png)
...
![css计算图](https://cdn.jsdelivr.net/gh/lazySir/image-host@main/lazySir_website/blog/css/css计算3.png)
...
![css计算图](https://cdn.jsdelivr.net/gh/lazySir/image-host@main/lazySir_website/blog/css/css计算4.png)


可以看到，落败的作者样式在 *Elements>Styles* 中会被划掉。

有关选择器权重的计算方式，不清楚的，可以进入此传送门：*https://developer.mozilla.org/en-US/docs/Web/CSS/Specificity*
...
![css计算图](https://cdn.jsdelivr.net/gh/lazySir/image-host@main/lazySir_website/blog/css/css计算5.png)
...
![css计算图](https://cdn.jsdelivr.net/gh/lazySir/image-host@main/lazySir_website/blog/css/css计算6.png)
...
![css计算图](https://cdn.jsdelivr.net/gh/lazySir/image-host@main/lazySir_website/blog/css/css计算7.png)
...
![css计算图](https://cdn.jsdelivr.net/gh/lazySir/image-host@main/lazySir_website/blog/css/css计算8.png)
...
![css计算图](https://cdn.jsdelivr.net/gh/lazySir/image-host@main/lazySir_website/blog/css/css计算9.png)
...
![css计算图](https://cdn.jsdelivr.net/gh/lazySir/image-host@main/lazySir_website/blog/css/css计算10.png)
